const logger = require('log4js').getLogger('Trc20Controller Controller');
const _ = require('lodash');
const InsightApiRepository = require("../Repositories/InsightApiRepository");

let Controllers = getControllers();

class Trc20Controller {
    ...
    fetchTransfers(cb, data) {
        ...
        return InsightApiRepository.fetchTrc20Transfers(contractAddress, {
            offset: offset,
            limit: limit,
            addresses: addresses
        }, (err, data) => {
...
Controllers.trc20 = new Trc20Controller();