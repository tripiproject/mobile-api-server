...
const logger = require('log4js').getLogger('TripiRoomEvents Socket Events');
...
class TripiRoomEvents {
    ...
    subscribeToTripiTrx() {
        ...
        this.socketClient.on('tripi/tx', (data) => {
...
module.exports = TripiRoomEvents;